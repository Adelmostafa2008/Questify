            ...
            <div className="relative z-10">
                ...
                <div className="py-5 border-b-[1px] border-[#333333]">
                    <h2 className="flex text-white text-xl font-semibold gap-x-2 uppercase tracking-[0.05em]">
                        <TbCirclePlusFilled size={25} color="#ce7d63"/> Create New Task
                    </h2>
                </div>
                ...
                <div className="flex text-white justify-center gap-[3%]">
                    <div className="flex flex-col w-[50%]">
                        ...
                        <input type="text" onChange={(e) => SetTask(prevtask => ({...prevtask , taskname : e.target.value}))} placeholder="Enter task title..." className="w-full px-4 py-2 bg-transparent border border-[#333333] rounded-md focus:outline-0 focus:border-[#ce7d63] focus:shadow-[0_0_4px_#ce7d63aa]"/>
                    </div>
                    <div className="flex flex-col w-[50%]">
                        <label className="text-[#b3b3b2] text-sm mb-2 mt-2">Category</label>
                        <select onChange={(e) => SetTask(prevtask => ({...prevtask , taskcategory : e.target.value}))} className="w-full bg-[#1f1f1f] px-4 py-2 border border-[#333333] rounded-md focus:outline-0 focus:border-[#ce7d63] focus:shadow-[0_0_4px_#ce7d63aa]">
                ...
                <div className="w-full flex flex-col pb-5">
                    ...
                    <textarea onChange={(e) => SetTask(prevtask => ({...prevtask , taskdescription : e.target.value}))} placeholder="Enter detailed task description..." className="text-white bg-transparent px-4 py-2 border border-[#333333] rounded-md focus:outline-0 focus:border-[#ce7d63] focus:shadow-[0_0_4px_#ce7d63aa] max-h-36 min-h-36"/>
                </div>
                ...
                <div className="flex text-white justify-around pb-10 gap-[3%]">
                    <div className="flex flex-col w-[50%]">
                        ...
                        <input type="number" placeholder="e.g., 30" onChange={(e) => SetTask(prevtask => ({...prevtask , tasktime : parseInt(e.target.value , 10)}))} max={120} min={30} className="px-4 py-2 bg-transparent border border-[#333333] rounded-md focus:outline-0 focus:border-[#ce7d63] focus:shadow-[0_0_4px_#ce7d63aa]"/>
                    </div>
                    <div className="flex flex-col w-[50%]">
                        <label className="text-[#b3b3b2] text-sm mb-2 mt-2">Maximum Points</label>
                        <input type="number" onChange={(e) => SetTask(prevtask => ({...prevtask ,taskpoints : parseInt(e.target.value , 10)}))} placeholder="e.g., 100" max={200} min={20} className="px-4 py-2 bg-transparent border border-[#333333] rounded-md focus:outline-0 focus:border-[#ce7d63] focus:shadow-[0_0_4px_#ce7d63aa]"/>
                    </div>
                </div>
