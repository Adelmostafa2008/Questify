        ...
        return (
          ...
          >
            ...
            <button
              ...
              className="bg-[#ce7d63] hover:cursor-pointer hover:bg-[#b96b53] text-white font-bold py-3 rounded-lg shadow-[0_0_10px_rgba(206,125,99,0.5)] transition-all duration-300"
            >
              Pay Now
            </button>
          </form>
      ...
      case "VodafoneCash":
        return (
          <div className="mt-6 p-5 bg-[#2a2a2a] rounded-lg border border-[#444] shadow-[0_0_15px_rgba(206,125,99,0.2)]">
            ...
            <button
              onClick={() => cool ? null : handelSnack()}
              className="bg-[#ce7d63] hover:cursor-pointer hover:bg-[#b96b53] w-[100%] my-3 text-white font-bold py-3 rounded-lg shadow-[0_0_10px_rgba(206,125,99,0.5)] transition-all duration-300"
            >
              Send Now
            </button>
          </div>
      ...
      case "PayPal":
        return (
          <div className="mt-6 p-5 bg-[#2a2a2a] rounded-lg border border-[#444] shadow-[0_0_15px_rgba(206,125,99,0.2)]">
            ...
            <button onClick={() => cool ? null : handelSnack()} className="bg-[#ce7d63] hover:cursor-pointer hover:bg-[#b96b53] text-white font-bold py-3 rounded-lg w-full shadow-[0_0_10px_rgba(206,125,99,0.5)] transition-all duration-300">
              Pay with PayPal
            </button>
          </div>
        );
