    ...
    switch (type) {
        case "login":
            return (
                <>
                    {/* Logo */}
                    <h1 onClick={() => navigate("/")} className="cursor-pointer  text-gray-300 font-bold m-0 max-sm:text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-center w-full mt-5">
            ...
            switch (page) {
                case "1":
                    return (
                        <>
                            {/* Logo */}
                            <h1 onClick={() => navigate("/")} className="text-gray-300 cursor-pointer font-bold m-0 max-sm:text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-center w-full mt-5">
                                Quest<span className="text-[var(--text)]">ify</span>
                            </h1>
