...
function Reg(props) {
  ...
  const handleLogin = async () => {
    try {
      ...
      if (
        ...
        err.response.data["error"] == "google_account"
      ) {
        {
          cool
            ? null
        ...
        {
          cool ? null : handelSnack(err.response.data, "error");
        }
      }
      throw err;
    }
  ...
  const handelGoogleLogin = async (creds) => {
    try {
      const res = await api.post("/regesteration/google", {
        Credintial: creds,
      });
      login(res.data);
      navigate("/Home");
  ...
  const handleSignup = async () => {
    try {
      ...
      if (err.response?.data?.errors?.email?.length > 0) {
        {
          cool ? null : handelSnack("Email address is not vaild", "error");
        }
      } else {
        {
          cool ? null : handelSnack(err.response.data, "error");
    ...
    case "login":
      return (
        <>
          ...
          <h1
            onClick={() => navigate("/")}
            className="cursor-pointer  text-gray-300 font-bold m-0 max-sm:text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-center w-full mt-5"
          >
          ...
          <div className="w-[28%] max-lg:w-[40%] max-md:w-[60%] max-sm:w-[85%] my-7 mx-auto rounded-2xl bg-[var(--cardbg)] border-2 border-[var(--anyborder)] relative overflow-hidden">
            ...
            <div className="relative z-10 px-7">
              ...
              <div className="py-6 border-b border-[var(--anyborder)] text-center">
                <h2 className="text-2xl font-semibold text-[var(--tasktext)]">
                  Welcome Back
                </h2>
                ...
                <form>
                  ...
                  <div className="mb-5">
                    ...
                    <div className="relative">
                      ...
                      >
                        {showPassword ? (
                          <FaEyeSlash className="text-[var(--subtext)]" />
                        ) : (
                          <FaEye className="text-[var(--text)]" />
                        )}
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center mt-4">
                    ...
                    <a
                      onClick={() =>
                        navigate("/Registration?regtype=forgetPass", {
                          state: { page: "1" },
                        })
                      }
        ...
        <>
          ...
          <div className="relative flex flex-col justify-center w-[28%] max-lg:w-[50%] max-sm:w-[90%] my-7 mx-auto bg-[var(--cardbg)] rounded-2xl border border-[var(--anyborder)] overflow-hidden">
            ...
            <div className="py-6 border-b border-[var(--anyborder)] text-center">
              ...
              <h4 className="text-md text-[var(--subtext)] mt-2">
                Join our platform to access tasks and challenges
              </h4>
            </div>
            ...
            <div className="relative z-10 w-[80%] mx-auto">
              <form>
                {/* Username */}
                <div className="my-5">
                  <label className="text-md font-semibold text-[var(--subtext)]">
                    Username
                  </label>
                  <div className="relative">
                        ...
                        if (
                        ...
                        ) {
                          {
                            cool
                              ? null
                              : handelSnack(
                                  "Please fill all fields and accept Terms of Service.",
                                  "info",
                                );
                          }
                          return;
                ...
                className={` ${
                  isChecked
                    ...
                    : "bg-transparent text-gray-500 border border-gray-600 invalidCursor"
                        ...
                        ${successSign ? "bg-green-600 text-white" : ""}`}
              >
                {loadingSign ? (
                  <>
                    <svg
            ...
            <div className="border-t border-[var(--anyborder)] py-6 mt-6 text-center">
              <h4 className="text-[var(--tasktext)] text-sm">
                ...
                <a
                  ...
                  className="text-[var(--text)] hover:underline font-semibold cursor-pointer"
                >
                  Login
                </a>
              </h4>
        ...
        case "1":
          return (
            <>
              ...
              <h1
                onClick={() => navigate("/")}
                className="text-gray-300 cursor-pointer font-bold m-0 max-sm:text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-center w-full mt-5"
              >
                Quest<span className="text-[var(--text)]">ify</span>
              </h1>
                ...
                <div className="relative z-10 px-7">
                  ...
                  <div className="text-center text-md font-semibold text-[var(--tasktext)] flex flex-col gap-y-5 mt-3 w-[85%] mx-auto">
                    ...
                    <p className="text-sm">
                      ...
                      <a className="text-[var(--text)] hover:underline cursor-pointer">
                        Resend
                      </a>
                    </p>
                  </div>
