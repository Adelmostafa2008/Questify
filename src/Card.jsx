            ...
            case "primeSub" :
                return(
                    ...
                    <div className="bg-[#e68d70] flex flex-col text-center max-w-[80%] mx-auto rounded-lg px-5 py-5">
                        ...
                        {btnContent}</button>
                        <ul className="flex gap-5 mx-auto my-5 max-xxs:flex-col">
            ...
            case "task" : 
                return(
                    ...
                    <div className="bg-[#1f1f1fe6] flex flex-col w-[100%] px-5 py-10 rounded-lg">
                        ...
                        <button className="mt-auto text-white bg-[#2b2b2b] px-5 py-1 w-1/3 min-w-max rounded-sm ">{btnContent}</button>
                    </div>
                    </>
                );
            break;
